...
\begin{par}
Copyright 2009, Timothy A. Davis, University of Florida.  June 4, 2009. \begin{verbatim}davis@cise.ufl.edu\end{verbatim} \begin{verbatim}http://www.cise.ufl.edu/~davis\end{verbatim}
\end{par} \vspace{1em}
\begin{par}
...
\begin{par}
However, the problem with Rule Number One is that it can be hard to figure out which matrix factorization to use and how to use it.  Using LU, CHOL, or QR is complicated, particularly if you want the best performance.  BACKSLASH (MLDIVIDE) is great, but it can't be reused when solving multiple systems (x=A\ensuremath{\backslash}b and y=A\ensuremath{\backslash}c).  Its syntax doesn't match the use of the inverse in mathematical expressions, either.
\end{par} \vspace{1em}
\begin{par}
...
\end{verbatim}
    ...
    0.0080    0.7399    0.7109
    0.7312    0.8500    0.9624
    0.1795    0.9276    0.7810
b =
    0.9329
    0.9665
    0.4506
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}1: nnz(L+U): 16151 time:   0.0069 resid: 1.457658e-10
2: nnz(L+U): 15826 time:   0.0147 resid: 2.028048e-10
3: nnz(L+U):  3704 time:   0.0052 resid: 1.322009e-10
\end{verbatim} \color{black}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 0.019922 seconds.
Elapsed time is 0.016146 seconds.
Elapsed time is 0.016911 seconds.
\end{verbatim} \color{black}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 0.652599 seconds.
Elapsed time is 0.814173 seconds.
Elapsed time is 0.319253 seconds.
Elapsed time is 0.316651 seconds.
\end{verbatim} \color{black}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 0.057574 seconds.
ans =
   2.6930e-12
Elapsed time is 0.337014 seconds.
ans =
   4.6494e-12
Elapsed time is 0.079387 seconds.
ans =
   1.9089e-12
Elapsed time is 0.078930 seconds.
ans =
   1.9089e-12
\end{verbatim} \color{black}
    \begin{par}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 0.114372 seconds.
Elapsed time is 0.340214 seconds.
Elapsed time is 0.081340 seconds.
Elapsed time is 0.081560 seconds.
\end{verbatim} \color{black}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 0.075625 seconds.
ans =
    2.9541
Elapsed time is 0.341637 seconds.
ans =
    0.4915
Elapsed time is 0.082095 seconds.
ans =
    0.4915
Elapsed time is 0.082641 seconds.
ans =
    0.4915
\end{verbatim} \color{black}
...
\end{verbatim}
    ...
    0.0323
    0.1255
Elapsed time is 0.803655 seconds.
ans =
    0.0323
    0.1255
Elapsed time is 0.318938 seconds.
\end{verbatim} \color{black}
...
\end{par} \vspace{1em}
\begin{par}
The explicit need for inv(A) (or S=A\ensuremath{\backslash}eye(n), which is the same thing) is RARE.  If you ever find yourself multiplying by the inverse, then you know one thing for sure.  You know with certainty that you don't know what you're doing.
\end{par} \vspace{1em}
\begin{verbatim}
A = rand (500) ;
tic ; S1 = inv (A) ;            ; toc
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 0.108688 seconds.
Elapsed time is 0.148066 seconds.
ans =
   3.3330e-12
Elapsed time is 1.669166 seconds.
Elapsed time is 0.198167 seconds.
ans =
   2.3702e-14
\end{verbatim} \color{black}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 0.032224 seconds.
Elapsed time is 0.191507 seconds.
ans =
   3.3421e-17
Elapsed time is 0.034899 seconds.
Elapsed time is 0.204334 seconds.
ans =
   3.2622e-17
\end{verbatim} \color{black}
...
\begin{par}
One caveat:  If you have a large number of very small systems to solve, the object-oriented overhead of creating and using an object can dominate the run time, at least in MATLAB R2009a.  For this case, if you want the best performance, stick with BACKSLASH, or LU and LINSOLVE (just extract the appropriate formulas from the M-files in the FACTORIZE package).
\end{par} \vspace{1em}
\begin{par}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Elapsed time is 2.326027 seconds.
Elapsed time is 0.338218 seconds.
Elapsed time is 0.219374 seconds.
\end{verbatim} \color{black}
