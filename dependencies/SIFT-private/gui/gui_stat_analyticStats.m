function varargout = gui_stat_analyticStats(varargin)
%
% GUI_STAT_ANALYTICSTATS M-file for gui_stat_analyticStats.fig
%      GUI_STAT_ANALYTICSTATS, by itself, creates a new GUI_STAT_ANALYTICSTATS or raises the existing
%      singleton*.
%
%      H = GUI_STAT_ANALYTICSTATS returns the handle to a new GUI_STAT_ANALYTICSTATS or the handle to
%      the existing singleton*.
%
%      GUI_STAT_ANALYTICSTATS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_STAT_ANALYTICSTATS.M with the given input arguments.
%
%      GUI_STAT_ANALYTICSTATS('Property','Value',...) creates a new GUI_STAT_ANALYTICSTATS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_stat_analyticStats_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_stat_analyticStats_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_stat_analyticStats

% Last Modified by GUIDE v2.5 28-Jun-2012 15:12:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_stat_analyticStats_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_stat_analyticStats_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_stat_analyticStats is made visible.
function gui_stat_analyticStats_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_stat_analyticStats (see VARARGIN)
...
function varargout = gui_stat_analyticStats_OutputFcn(hObject, eventdata, handles) 
