function varargout = gui_stat_bsplSmoother(varargin)
%
% GUI_STAT_BSPLSMOOTHER M-file for gui_stat_bsplSmoother.fig
%      GUI_STAT_BSPLSMOOTHER, by itself, creates a new GUI_STAT_BSPLSMOOTHER or raises the existing
%      singleton*.
%
%      H = GUI_STAT_BSPLSMOOTHER returns the handle to a new GUI_STAT_BSPLSMOOTHER or the handle to
%      the existing singleton*.
%
%      GUI_STAT_BSPLSMOOTHER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_STAT_BSPLSMOOTHER.M with the given input arguments.
%
%      GUI_STAT_BSPLSMOOTHER('Property','Value',...) creates a new GUI_STAT_BSPLSMOOTHER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_stat_bsplSmoother_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_stat_bsplSmoother_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_stat_bsplSmoother

% Last Modified by GUIDE v2.5 28-Jun-2012 15:17:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_stat_bsplSmoother_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_stat_bsplSmoother_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_stat_bsplSmoother is made visible.
function gui_stat_bsplSmoother_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_stat_bsplSmoother (see VARARGIN)

set(hObject,'name','Spline Smoothing');
...
if isempty(varargin)
    error('You must pass ALLEEG to gui_bsplSmoother');
end
...
uiwait(handles.gui_bsplSmoother);


% --- Outputs from this function are returned to the command line.
function varargout = gui_stat_bsplSmoother_OutputFcn(hObject, eventdata, handles) 
...
handles.ExitButtonClicked = 'Cancel';
guidata(hObject,handles);
uiresume(handles.gui_bsplSmoother)
...
doc('pop_stat_bsplSmoother');


function gui_bsplSmoother_ResizeFcn(hObject, eventdata, handles)
